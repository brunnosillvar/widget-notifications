  ...
  return (
    <>
      <div className="w-[448px] rounded overflow-hidden">
        <button onClick={() => handleButton()}>Is Dark</button>        
        {/* Header */}
          ...
          <div className='divide-y-2 divide-zinc-300 dark:divide-zinc-950'>
            ...
            <div className="bg-zinc-200 dark:bg-zinc-900 px-8 py-4 flex items-start gap-6">
              ...
              <div className='flex gap-2 self-center'>
                <Button>x</Button>
                <button className='w-8 h-8 rounded flex items-start justify-center bg-zinc-800 hover:bg-zinc-700'>
                  <X className='w-3 h-3 text-zinc-50 mt-3' />
                </button>
                <button className='w-8 h-8 rounded flex items-start justify-center bg-violet-500 hover:bg-violet-600'>
                  <Check className='w-3 h-3 text-zinc-50 mt-3' />
                </button>
              </div>
            </div>
          </div>
